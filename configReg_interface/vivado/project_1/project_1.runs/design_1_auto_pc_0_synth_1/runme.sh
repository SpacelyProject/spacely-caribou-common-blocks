...
HD_PWD='/asic/projects/C/CMS_PIX_28/nehak/spacely/spacely-caribou-common-blocks/configReg_interface/vivado_new/project_1/project_1.runs/design_1_auto_pc_0_synth_1'
cd "$HD_PWD"
