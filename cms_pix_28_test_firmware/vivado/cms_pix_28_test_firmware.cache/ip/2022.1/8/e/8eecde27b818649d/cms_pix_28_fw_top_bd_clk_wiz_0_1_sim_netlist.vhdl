...
-- Date        : Mon Jun 17 17:40:05 2024
-- Host        : fasic-beast2.fnal.gov running 64-bit Scientific Linux release 7.9 (Nitrogen)
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ cms_pix_28_fw_top_bd_clk_wiz_0_1_sim_netlist.vhdl
-- Design      : cms_pix_28_fw_top_bd_clk_wiz_0_1
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_cms_pix_28_fw_top_bd_clk_wiz_0_1_clk_wiz is
  port (
    clk_out1 : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_cms_pix_28_fw_top_bd_clk_wiz_0_1_clk_wiz;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_cms_pix_28_fw_top_bd_clk_wiz_0_1_clk_wiz is
  signal clk_in1_cms_pix_28_fw_top_bd_clk_wiz_0_1 : STD_LOGIC;
  signal clk_out1_cms_pix_28_fw_top_bd_clk_wiz_0_1 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_cms_pix_28_fw_top_bd_clk_wiz_0_1
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_cms_pix_28_fw_top_bd_clk_wiz_0_1,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_cms_pix_28_fw_top_bd_clk_wiz_0_1,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_cms_pix_28_fw_top_bd_clk_wiz_0_1,
...
begin
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_cms_pix_28_fw_top_bd_clk_wiz_0_1_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1
    );
