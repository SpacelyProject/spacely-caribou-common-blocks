...
| FPGA_REGISTER_N           | 9     | Number of addressable registers in the SPI controller interface. |
...
| fpga_reg_use_ext_spi_clk | 1 | Y | Y | When this register is set to 1'b1, an external input clock (ext_spi_clk) is used to generate spi_clk. Otherwise, S_AXI_ACLK is used. |
...
| ext_spi_clk       | 1b input                       | ext_spi_clk   | Optional external clock to be used instead of AXI Clk to generate spi_clk. If unused, this input can be disconnected. | 
...
spi_opcode_group,0xC,0xFF,True,True
...
use_ext_spi_clk,0x1C,0x1,True,True

spi_done,0x20,0x1,True,False
