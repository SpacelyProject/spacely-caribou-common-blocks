...
//               /asic/projects/S/SParkDream/gingu/peary-firmware-sprocket3/submodules/spacely-caribou-common-blocks/dr_gth/src/gtwizard_ultrascale_0/gtwizard_ultrascale_0_stub.v
...
module gtwizard_ultrascale_0(gtwiz_userclk_tx_active_in, 
  ...
  qpll0outclk_out, qpll0outrefclk_out, qpll1outclk_out, qpll1outrefclk_out, dmonitorclk_in, 
  drpaddr_in, drpclk_in, drpdi_in, drpen_in, drpwe_in, gthrxn_in, gthrxp_in, pcsrsvdin_in, 
  rxusrclk_in, rxusrclk2_in, txusrclk_in, txusrclk2_in, dmonitorout_out, drpdo_out, drprdy_out, 
  gthtxn_out, gthtxp_out, gtpowergood_out, rxoutclk_out, rxpmaresetdone_out, txoutclk_out, 
  txpmaresetdone_out)
