...
#
# Generated by export_simulation on Tue Feb 27 08:46:19 CST 2024
#
################################################################################
...
'-reset_run' switch to the './demo1_ps_only.sh' script.

./demo1_ps_only.sh -reset_run
...
./demo1_ps_only.sh -noclean_files

For more information on the script, please type './demo1_ps_only.sh -help'.
