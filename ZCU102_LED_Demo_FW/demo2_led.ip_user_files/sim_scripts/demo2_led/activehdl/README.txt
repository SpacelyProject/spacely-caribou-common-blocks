...
#
# Generated by export_simulation on Tue Apr 09 15:37:59 CDT 2024
#
################################################################################
...
'-reset_run' switch to the './demo2_led.sh' script.

./demo2_led.sh -reset_run
...
./demo2_led.sh -noclean_files

For more information on the script, please type './demo2_led.sh -help'.
