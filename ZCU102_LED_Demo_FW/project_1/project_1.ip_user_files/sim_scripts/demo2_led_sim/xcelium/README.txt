...
#
# Generated by export_simulation on Tue Apr 09 15:38:20 CDT 2024
#
################################################################################
...
'-reset_run' switch to the './demo2_led_sim.sh' script.

./demo2_led_sim.sh -reset_run
...
./demo2_led_sim.sh -noclean_files

For more information on the script, please type './demo2_led_sim.sh -help'.
