...
set_multicycle_path 3 -from [get_pins -hierarchical -filter {NAME =~ *lpgbtFpga_top_inst/uplink_inst/frame_pipelined_s_reg[*]/C}] -setup
set_multicycle_path 2 -from [get_pins -hierarchical -filter {NAME =~ *lpgbtFpga_top_inst/uplink_inst/frame_pipelined_s_reg[*]/C}] -hold
